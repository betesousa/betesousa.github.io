...
function changeSlide(change) {
    ...
    windowHeight = mobileCheck()? ((ionic.Platform.isIOS()) ? window.screen.height : window.innerHeight * window.devicePixelRatio) : window.innerHeight;
    window.scrollTo(0, window.innerHeight * currentSlide);
}

// Base on https://stackoverflow.com/questions/11381673/detecting-a-mobile-browser
